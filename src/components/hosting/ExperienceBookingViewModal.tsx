    ...
    <div style={{
      ...
      <div style={{ background: '#fff', borderRadius: 16, minWidth: 720, padding: 32, boxShadow: '0 8px 32px #0002', position: 'relative', display: 'flex', gap: 36 }}>
        ...
        <div style={{ flex: 1, minWidth: 320, background: '#f7fafd', borderRadius: 12, boxShadow: '0 2px 8px #328e6e22', padding: 24 }}>
          <h3 style={{ fontSize: 20, fontWeight: 800, marginBottom: 18, color: '#328E6E', letterSpacing: 0.2 }}>Booking Information</h3>
          <div style={{ marginBottom: 12 }}><span style={{ fontWeight: 600, color: '#222' }}>Booking ID:</span> <span style={{ color: '#555' }}>{booking.id}</span></div>
          <div style={{ marginBottom: 12 }}><span style={{ fontWeight: 600, color: '#222' }}>Guest Name:</span> <span style={{ color: '#555' }}>{booking.profile_name || booking.user_id || 'N/A'}</span></div>
          ...
          <div style={{ marginBottom: 12 }}><span style={{ fontWeight: 600, color: '#222' }}>Phone:</span> <span style={{ color: '#555' }}>{booking.tPhone || booking.phone || booking.guest_phone || 'N/A'}</span></div>
          {/* Show listing experience title */}
          <div style={{ marginBottom: 12 }}><span style={{ fontWeight: 600, color: '#222' }}>Experience Name:</span> <span style={{ color: '#555' }}>{booking.listingTitle || 'N/A'}</span></div>
