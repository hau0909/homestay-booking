...
import { getExperienceSlotById } from "@/src/services/experience/getExperienceSlotById";
    ...
    const fetchBooking = async () => {
      ...
      try {
        ...
        if (data) {
          ...
          if (data.experience_slot_id) {
            const slotData = await getExperienceSlotById(
              data.experience_slot_id,
            );
            setSlot(slotData);
          }
        }
        ...
        <div className="max-w-md w-full border rounded-2xl p-8 text-center space-y-6 shadow-md">
          ...
          <div className="border rounded-xl p-4 text-left text-sm space-y-2">
            ...
            <p>
              ...
              {booking.total_guests > 1 ? "guests" : "guest"}
            </p>
